...
const PHASES = [
  {
    number: 'I',
    title: 'Foundation',
    subtitle: 'API + Data Pipeline + Nessie',
    timeline: '2025–2026',
    status: 'In Progress' as const,
    description: 'Production-ready verification API with x402 micropayments, global data ingestion pipeline, and the first Nessie prototype trained on verified regulatory data.',
    items: [
      'Public REST API with x402 micropayment integration',
      'Global data ingestion pipeline (EDGAR, USPTO, Federal Register, OpenAlex)',
      'Nessie verified intelligence engine — RAG over anchored regulatory corpus',
      'Client-side SHA-256 fingerprinting — documents never leave your device',
      'MCP server for AI agent integration (Claude, GPT, LangChain)',
      'Organization management, credential templates, and bulk upload',
      'Free tier: 10,000 verifications/month',
      'Developer documentation, sandbox environment, and API playground',
    ],
  ...
  },
  {
    ...
    description: 'Deploy Nessie in production, scale to 10+ jurisdictions, and launch compliance-as-a-service. The platform transitions from verification infrastructure to full compliance intelligence.',
    items: [
      'Nessie deployed in production (RAG + fine-tuned domain-specific model)',
      'Multi-jurisdiction regulatory intelligence with automated monitoring',
      'Compliance-as-a-service: automated checks against anchored regulatory corpus',
      'Agent identity verification and compliance certificates',
      'Real-time regulatory change detection across jurisdictions',
      'Multi-tenant compliance dashboards',
      '10+ jurisdictions fully covered with anchored regulatory data',
    ],
  ...
  },
  {
    number: 'III',
    title: 'Dominance',
    subtitle: 'Full CCO Replacement',
    timeline: '2027–2028',
    status: 'Future' as const,
    description: 'Autonomous compliance agents that monitor, flag, and remediate regulatory issues without human intervention. The platform becomes the operating system for global compliance.',
    items: [
      'Autonomous compliance agents — monitor, flag, and remediate',
      'E-signatures with eIDAS and jurisdiction-specific legal recognition',
      'QTSP partnership for qualified trust services',
      'Platform licensing for compliance product builders',
      'Enterprise compliance suite replacing manual CCO workflows',
      'Continuous audit trails with cryptographic proof across 30+ jurisdictions',
    ],
