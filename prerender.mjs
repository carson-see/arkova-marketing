...
function generateApiHomeFunction(distPath) {
  ...
  const fn = [
    ...
    "      'vary': 'accept',",
    '      // private + no-store keeps Vercel\'s edge CDN from caching this response.',
    '      // Without it the CDN HITs the first variant (HTML) and serves it for',
    '      // every Accept including text/markdown. Verified post-#30 deploy.',
